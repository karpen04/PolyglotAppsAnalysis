...
var graalVMVersion: String = "23.1.1";
...
application {
    mainClass.set("pascal.taie.analysis.custom.TestExecutor")
}
...
task("fatJar", type = Jar::class) {
    ...
    manifest {
        attributes["Main-Class"] = "pascal.taie.analysis.custom.TestExecutor"
    ...
    from(
      //  configurations.runtimeClasspath.get().map {
        ...
        //}
        configurations.runtimeClasspath.get().filter { it.extension == "jar" }.map {
            zipTree(it)
        }
    ) {
